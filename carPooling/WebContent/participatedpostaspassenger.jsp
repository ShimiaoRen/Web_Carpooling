...
<head>
	...
	<!--Title-->
	<title>Participated Post As Passenger</title>
...
<body>
	...
	<!-- <div id="respond" class="clearfix"> -->
		...
		<h3 id="reply-title">Information Of My Participated Posts----I AM A Passenger</h3>
       <s:form action="" method="post"> 
 <table border="0" align="center" >
<tr>
     <td><div align="center">Driver's Post ID</div></td>
     <td><div align="center">Departure</div></td>  
     <td><div align="center">Destination</div></td>  
     <td><div align="center">Date</div></td>  
     <td><div align="center">Time</div></td>  
     <td><div align="center">Available Seats</div></td>  
      <td><div align="center">Car Type</div></td>  
      <td><div align="center">Estimated Total Cost</div></td>  
            <td><div align="center">Estimated Cost Per Passenger</div></td>  
     ...
     <s:iterator value="detaillist2" status="stuts"> 
        <tr align="center"> 
               ...
               <td><s:property value="numberofappliedpassengers" /></td>
                 ...
                 <td><s:url id="url" action="manageparticipatedpost_seedetails2"> 
              <s:param name="postID" value="postID"></s:param> 
                  </s:url>
            <s:a  href="%{url}">See Details</s:a></td>  
            
              <td><s:url id="url2" action="manageparticipatedpost_exitparticipation2"> 
              <s:param name="postID" value="postID"></s:param> 
                  </s:url>
