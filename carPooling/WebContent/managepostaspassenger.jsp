...
<body>
	...
	<div class="wrapper">
		...
		<div id="site-title">
			<a href="index.jsp">
				<h1>Manage My Post As Passenger<span></span></h1>
			</a>
		<!-- END #site-title -->
		</div>
	...
	<!-- <div id="respond" class="clearfix"> -->
		...
		<h3 id="reply-title">Posts' Information As Passenger</h3>
	...
	<tr>
     ...
     <td><div align="center">Need Seats</div></td>  
      ...
      <td><div align="center">Memo</div></td>  
        ...
        <td><div align="center">Operations</div></td> 
     ...
     <s:iterator value="postlist" status="stuts"> 
        <tr align="center"> 
         <td><s:property value="postID" /></td> 
          ...
          <td><s:url id="url" action="managepost_seedrivers"> 
              <s:param name="postID" value="postID"></s:param> 
                  </s:url>
          <s:a  href="%{url}">See Potential Drivers</s:a></td>  
          
           <td><s:url id="url2" action="managepost_deletepostaspassenger"> 
              <s:param name="postID" value="postID"></s:param> 
                  </s:url>
