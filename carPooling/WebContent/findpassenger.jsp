...
<body>
	...
	<div class="wrapper">
		...
		<div id="site-title">
			<a href="index.jsp">
				<h1>Find Passenger<span></span></h1>
			</a>
		<!-- END #site-title -->
		</div>
		...
		<!-- <div class="section">
			...
			<ul class="columns-content page-content clearfix"> -->
				...
				<tr>
					...
					<td>
						<s:submit value="search" action="searchpassenger_search"></s:submit>                         
					</td>
				</tr>
...
<tr><td height=10px colspan="7" valign="top"><hr></td></tr>	
	<tr>
     ...
     <td width="13%"><div align="center">Need Seats</div></td>  
         ...
         <td><s:property value="postID" /></td> 
            <td><s:property value="departure" /></td> 
             <td><s:property value="destination" /></td> 
              ...
              <td><s:url id="url" action="findPassenger_seedetails"> 
