...
<body>
	...
	<div class="wrapper">
		...
		<div id="site-title">
			<a href="index.jsp">
				<h1>Post As Driver<span></span></h1>
			</a>
		<!-- END #site-title -->
		</div>
	...
	<!-- 	<div class="section">
			...
			<!-- 	<li class="col-main"> -->
					...
					<h2 class="page-title">Create Post As Driver</h2>			
				<!-- 	<div id="respond" class="clearfix"> -->
							
			<s:form action="postAsDriver_post" method="post">
			...
			<table border="0" align="center" >		
			 ...
			 <tr>
				...
				<tr>
                      <td>
						<s:textfield name="estimatedtotalcost" label="Estimated Total Cost(*)" ></s:textfield>
					</td>         
				</tr>	
				...
				<tr>
                      <td>
						<s:textfield name="estimatedcostperpassenger" label="Estimated Cost per Passenger(*)" ></s:textfield>
					</td>         
				</tr>	
				 ...
				 <tr>
				   ...
				   <tr>
					<td>
					<label>Memo:</label>
						<s:textarea name="memo"  width="80px" height="100px"></s:textarea>
					</td>
				</tr>	
			 ...
			 <tr>
                   ...
                   <td >
                                        ...
                                        <s:submit value="Cancel"  action="postAsDriver_cancel"></s:submit>
					</td>
				</tr>		
