...
<body>
	...
	<div class="wrapper">
		...
		<div id="site-title">
			<a href="index.jsp">
				<h1>Revise Profile<span></span></h1>
			</a>
		<!-- END #site-title -->
		</div>
	...
	<!-- <div id="respond" class="clearfix"> -->
		<h3 id="reply-title">Revise Profile</h3>
       <s:form action="reviseprofile_revise" method="post"> 
			 ...
			 <tr>
					<td>
                                        ...
                                        <td>
                                        <s:submit value="Cancel" action="reviseprofile_cancel"></s:submit>
					</td>
				</tr>										
		  </table>	
								</s:form>
